...
\begin{document}
	...
	\paragraph{Scalability: Server needs to handle up to 100 000 simultaneous connections.}
	\paragraph{Reliability: The entire system should be portable to endure close to 100% up
	time.}
	\paragraph{Quality: Server needs to ensure that data is valid and consistent.}
	\paragraph{Recoverability: If the device goes offline, data should not be lost.}
	\paragraph{Security: Security of devices should be handled to prevent unauthorized
	devices to log data.}
